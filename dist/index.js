                                        ...
                                        return _ts_generator(this, function(_state) {
                                            switch(_state.label){
                                                ...
                                                case 3:
                                                    return [
                                                        4,
                                                        (0, import_shiki.codeToHtml)(node.value, _object_spread_props(_object_spread({}, options.codeToHtmlOptions), {
                                                            lang: lang,
                                                            transformers: transformers
                                                        }))
                                                    ];
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        4,
                        (0, import_shiki.createHighlighter)(options.highlighterOptions)
                    ];
                case 1:
